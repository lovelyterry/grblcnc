...
#define RCC_CONTROL_RESET_PORT        RCC_APB2Periph_GPIOB
#define GPIO_CONTROL_RESET_PORT       GPIO_PortSourceGPIOB
#define CONTROL_RESET_BIT             3
#define CONTROL_FEED_HOLD_PORT        GPIOB
#define RCC_CONTROL_FEED_HOLD_PORT    RCC_APB2Periph_GPIOB
#define GPIO_CONTROL_FEED_HOLD_PORT   GPIO_PortSourceGPIOB
#define CONTROL_FEED_HOLD_BIT         1
#define CONTROL_CYCLE_START_PORT      GPIOB
#define RCC_CONTROL_CYCLE_START_PORT  RCC_APB2Periph_GPIOB
#define GPIO_CONTROL_CYCLE_START_PORT GPIO_PortSourceGPIOB
#define CONTROL_CYCLE_START_BIT       0
#define CONTROL_SAFETY_DOOR_PORT      GPIOA
#define RCC_CONTROL_SAFETY_DOOR_PORT  RCC_APB2Periph_GPIOA
#define GPIO_CONTROL_SAFETY_DOOR_PORT GPIO_PortSourceGPIOA
